...
class InternalCommands():
    ...
    def configureCore(self, target = '', extraArgs = ''):
        ...
        if sys.platform == 'darwin':
            ...
            cmake_args += ' -DCMAKE_OSX_SYSROOT=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS8.4.sdk'
            cmake_args += ' -DCMAKE_CXX_FLAGS="-arch armv7 -arch armv7s -arch arm64 -isysroot %s -DHAVE_PTHREAD -I/Users/diego/tarballs/iOScURL/iOScURL/"' % (sysroot, )
            cmake_args += ' -DCMAKE_C_FLAGS="-arch armv7 -arch armv7s -arch arm64 -isysroot %s -DHAVE_PTHREAD -I/Users/diego/tarballs/iOScURL/iOScURL/"' % (sysroot, )      
